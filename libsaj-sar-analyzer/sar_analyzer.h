...
/* svg_memory_memused_obj */
struct line_data2 svg_memory_memused_obj_raw =
    {
        "", /* each line */
        "", /* each line */
        NULL /* next pointer */
...
/* svg_memory_swpused_obj */
struct line_data2 svg_memory_swpused_obj_raw =
    {
        "", /* each line */
        "", /* each line */
        NULL /* next pointer */
...
/* svg_ldavg_one_obj */
struct line_data2 svg_ldavg_one_obj_raw =
    {
        "", /* each line */
        "", /* each line */
        NULL /* next pointer */
...
/* svg_ldavg_five_obj */
struct line_data2 svg_ldavg_five_obj_raw =
    {
        "", /* each line */
        "", /* each line */
        NULL /* next pointer */
...
/* svg_ldavg_15_obj */
struct line_data2 svg_ldavg_15_obj_raw =
    {
        "", /* each line */
        "", /* each line */
        NULL /* next pointer */
...
/* for file load average */
struct line_data2* svg_ldavg_one_obj = &svg_ldavg_one_obj_raw;
struct line_data2* svg_ldavg_five_obj = &svg_ldavg_five_obj_raw;
struct line_data2* svg_ldavg_15_obj = &svg_ldavg_15_obj_raw;
